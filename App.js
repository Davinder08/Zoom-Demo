...
const ZOOM_APP_KEY = 'mavvHdqhYmrHTAD4oQvEc4Hcw9AlE5Uzueyz';
const ZOOM_APP_SECRET = 'fSswS8krxbeTgB6twuZxzpYojTwG4EvGwRom';

const ZOOM_JWT_APP_KEY = 'M_yKzSgfT1eHnrpfUaWFCA';
const ZOOM_JWT_APP_SECRET = 'XIwJCf572MeVDlYhv06uR09CdpersHXQ33AK';
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>Zoom Demo</Text>
